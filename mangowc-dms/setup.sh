...
ln -sf $DOTFILES/hypr-idle/hypridle.conf $CONFIG/hypr/hypridle.conf
ln -sf $DOTFILES/dms/settings.json $CONFIG/DankMaterialShell/settings.json
ln -sf $DOTFILES/dms/themes/sebatttheme.json $CONFIG/DankMaterialShell/themes/sebatttheme.json
